...
<!-- Meta Tags -->
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="description" content="Makaan template">
                                ...
                                <div class="featured-thumb hover-zoomer mb-4">
                                    ...
                                    <div class="featured-thumb-data shadow-one">
                                        ...
                                        <div class="px-4 pb-4 d-inline-block w-100">
                                            <?php 
                                                $name = mysqli_fetch_array(mysqli_query($con,"SELECT uname from user where uid = '{$row['23']}'"));
                                            ?>
                                            <div class="float-left text-capitalize"><i class="fas fa-user text-primary mr-1"></i>By : <?php echo $name['0'];?></div>
