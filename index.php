...
<div id="page-wrapper">
    <div class="row"> 
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Atque, minus.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti, repellendus.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Hic, atque. Asperiores odio omnis totam odit rerum similique quam, ad quos.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										<h5 class="mb-3">Experience Quality</h5>
										<p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Totam magnam deleniti expedita rem, repellendus ad veritatis odit! Vitae, quo dolore.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										<h5 class="mb-3">Experience Quality</h5>
										<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia praesentium blanditiis cupiditate tenetur sit necessitatibus quas veniam exercitationem non inventore?</p>
									</div>
                                </li>
                            </ul>
                        </div>
        ...
        <!--	Achievement
        ============================================================-->
        <div class="full-row overlay-secondary" style="background-image: url('images/counter.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/3.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
										$query=mysqli_query($con,"SELECT count(state), property.* FROM property where state='jharkhand'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-primary text-capitalize"><a href="stateproperty.php?id=<?php echo $row['17']?>"><?php echo $row['state'];?></a></h4>
							...
							<div class="mb-3 col-lg-12">
								<h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4">Testimonial</h4>
									<div class="recent-review owl-carousel owl-dots-gray owl-dots-hover-primary">
										...
										?>
										<div class="item">
											<div class="p-4 bg-primary position-relative">
