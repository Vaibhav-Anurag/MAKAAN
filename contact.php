...
<!--	Title
	=========================================================-->
<title>Makaan - Real Estate Template</title>
</head>
<body>
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-secondary">Srinivasnagar, Surathkal, Mangalore, Karnataka</span> 
                                ...
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
										...
										<span class="d-table text-secondary">helpline@Makaan.com</span>
