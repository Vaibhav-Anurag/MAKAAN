<footer class="full-row bg-secondary p-0">
            <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        <div class="footer-logo mb-4"> <a href="#"><img class="logo-bottom" src="images/logo/bada-makan.png" alt="image"></a> </div>
                                        <p class="pb-20 text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus aliquam tempore quisquam corrupti incidunt doloribus sapiente dolore, minima sed nesciunt ullam, ex facilis iure facere, accusamus labore earum velit similique?</p>
										<p class="pb-20 text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente natus voluptate quod laborum excepturi nulla officiis perspiciatis, nihil nesciunt ullam?</p>
                                        </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>Srinivasnagar, Surathkal, Mangalore, Karnataka</li>
                                                    <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+1 234567899</li>
													<li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+1 234567890</li>
                                                    <li class="hover-text-primary"><i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>helpline@Makaan.com</li>
                                                </ul>
                                            </div>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© 2024 MAKAAN All right reserved</span> </div>
                    <div class="col-sm-6">
